<!-- profile: auv mission terminal -->
<div align="center">

<img src="./assets/auv-bringup.svg" alt="AUV bring-up and autonomous survey log" width="740">

<br>

# Ivan Dovbush

**I build autonomous systems that move from simulation to the field.**
...
**Ulysses** · **CPSDrone** · **Birck Nanotechnology Center** · **Purdue Aerial Robotics**

### `Stack`

`Python` `C++` `C` `Rust` `ROS 2` `Docker` `Ansible`  
`STM32` `CAN` `Pixhawk` `Jetson` `KiCad` `SolidWorks`
